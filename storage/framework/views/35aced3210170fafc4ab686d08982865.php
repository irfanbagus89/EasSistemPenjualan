...
<body>
    ...
    <section class="w-full min-h-screen">
        ...
        <div class="w-full h-auto p-4">
            <div class="w-11/12 h-[600px] max-w-5xl bg-white rounded-xl shadow-lg p-4 relative mt-4 mx-auto">
                <form action="/updateObat" method="post" class="w-full h-full" encType="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <input
                            type="hidden"
                            ...
                            id="id_obat"
                            name="id_obat"
                            value="<?php echo e($data->id_obat); ?>"
                          />
                    <div class="w-full h-full p-4 flex flex-col items-center gap-4">
                        <h1 class="p-4 text-4xl font-bold">Edit Obat</h1>
...
</html><?php /**PATH C:\Users\USER\Desktop\eas065\resources\views/Editobat.blade.php ENDPATH**/ ?>