                ...
                <div class="w-full min-h-[30rem]">
                    <table  class='w-full h-auto text-center border'>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class='border'><?php echo e($index + $data->firstItem()); ?></td>
                                    <td class='border w-12 h-12'><img src='<?php echo e(asset('storage/'.$dt->foto)); ?>' alt=<?php echo e($dt->foto); ?>></td>
                                    <td class='border'><?php echo e($dt->nama); ?></td>
                                    <td class='border max-w-sm'><?php echo e($dt->deskripsi); ?></td>
                                    <td class='border'><?php echo e($dt->harga); ?></td>
                                    <td class='border flex justify-evenly'>
                                        <div class="w-8 h-11">
                                            <a href="/editObat/<?php echo e($dt->id_obat); ?>">
                                              <img src="<?php echo e(asset('assets/pencil.svg')); ?>" class="w-full h-8" alt="">
                                            </a>
                                        </div>
                                        <div class="w-8 h-11">
                                            <a href="/deleteObat/<?php echo e($dt->id_obat); ?>">
                                                <img src="<?php echo e(asset('assets/trash.svg')); ?>" class="w-full h-8" alt="">
                                            </a>
                                        </div>
                                    </td>
                                </tr>    
...
<?php /**PATH C:\Users\USER\Desktop\eas065\resources\views/Obatpage.blade.php ENDPATH**/ ?>